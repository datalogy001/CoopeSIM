...
ionViewDidEnter() {
  const savedSegment = sessionStorage.getItem('coop_selectedSegment');
  if (savedSegment) {
    this.selectedSegment = savedSegment;
    sessionStorage.removeItem('coop_selectedSegment');
  } else {
  ...
  gotoNoti() {
    ...
    sessionStorage.setItem('coop_selectedSegment', this.selectedSegment);
