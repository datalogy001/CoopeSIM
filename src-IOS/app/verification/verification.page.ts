  ...
  async createSuccess() {
    ...
    this.service.createAccount(this.tempData.registerObj).then((res: any) => {
      ...
      if (res.code == 200) {
        ...
        window.localStorage.setItem('coop_user_wallets',res.data[0]['data']['user_wallet']);
        window.localStorage.setItem('coop_refer_balance',res.data[0]['data']['referal_wallet']);
        window.localStorage.setItem('coop_refer_code', res.data[0]['data']['referal_code']);
