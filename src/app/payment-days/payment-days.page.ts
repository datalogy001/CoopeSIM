...
export class PaymentDaysPage implements OnInit {
  ...
  iccid: any;
  networks: any = [];
  stripeCardObj: any = { "is_couped_applied": 0, "currency": "", "original_amount": "", "coupon_code": "", "payment_type": "", "percentage": "", "discount_amount": "", 'payment_intent': [], 'customer_id': '', 'card_source': '', 'card_id': '', 'bundle': '', 'isTermsSelected': false, 'iccid': '' };
  paymentMethod: any = [];
