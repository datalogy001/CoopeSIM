...
export class NotificationSettingsPage implements OnInit {
  ...
  ngOnInit() {
    ...
    this.promoEmail = window.localStorage.getItem('coop_emailSettings');
    if (this.promoEmail == null || this.promoEmail == 0) {
      this.emailSettings.status = 0;
    } else {
      this.emailSettings.status = window.localStorage.getItem('coop_emailSettings');
    }

    this.promoSettingsObj = window.localStorage.getItem('coop_promoSettings');
    console.log(window.localStorage.getItem('coop_promoSettings'));
    if (this.promoSettingsObj == null || this.promoSettingsObj == 0 || this.promoSettingsObj == undefined || this.promoSettingsObj == 'undefined') {
      ...
      this.promoSettings.status = window.localStorage.getItem('coop_promoSettings');
    }

    this.paymentSettingsObj = window.localStorage.getItem('coop_paymentSettings');
    ...
    if (this.paymentSettingsObj == null || this.paymentSettingsObj == 0 || this.paymentSettingsObj == undefined || this.paymentSettingsObj == 'undefined') {
      ...
      this.paymentSettings.status = window.localStorage.getItem('coop_paymentSettings');
    }

    this.serviceSettingsObj = window.localStorage.getItem('coop_serviceSettings');
    ...
    if (this.serviceSettingsObj == null || this.serviceSettingsObj == 0 || this.serviceSettingsObj == undefined || this.serviceSettingsObj == 'undefined') {
      ...
      this.serviceSettings.status = window.localStorage.getItem('coop_serviceSettings');
    }
  ...
  async togglePromoChanged() {
    ...
    this.service.getupdatePromoSettings(this.token, this.promoSettings).then((res: any) => {
      if (res.code == 200) {
        ...
        window.localStorage.setItem("coop_promoSettings", this.promoSettings.status);
  ...
  async toggleServiceChanged() {
    ...
    this.service.getupdateServiceSettings(this.token, this.serviceSettings).then((res: any) => {
      if (res.code == 200) {
        this.loadingScreen.dismissLoading();
        window.localStorage.setItem("coop_serviceSettings", this.serviceSettings.status);
        this.successMSGModal(
          this.translate.instant('SETTINGS_UPDATED_SUCCESS'),
          this.translate.instant('SETTINGS_UPDATE'),
          "2000"
  ...
  async togglePaymentChanged() {
    ...
    this.service.getupdatePaymentSettings(this.token, this.paymentSettings).then((res: any) => {
      if (res.code == 200) {
        this.loadingScreen.dismissLoading();
        window.localStorage.setItem("coop_paymentSettings", this.paymentSettings.status);
        this.successMSGModal(
          this.translate.instant('SETTINGS_UPDATED_SUCCESS'),
          this.translate.instant('SETTINGS_UPDATE'),
          "2000"
  ...
  async toggleChanged() {
    ...
    this.service.getupdatePromotion(this.token, this.emailSettings).then((res: any) => {
      if (res.code == 200) {
        this.loadingScreen.dismissLoading();
        window.localStorage.setItem("coop_emailSettings", this.emailSettings.status);
        this.successMSGModal(
          this.translate.instant('SETTINGS_UPDATED_SUCCESS'),
          this.translate.instant('SETTINGS_UPDATE'),
          "2000"
