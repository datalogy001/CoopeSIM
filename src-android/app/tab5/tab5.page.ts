...
ngOnDestroy() {
  ...
  ionViewDidEnter() {
    ...
    if (window.localStorage.getItem('coop_userDetails') != null) {
...
if (this.tempDetails && typeof this.tempDetails.first_name === 'string') {
  ...
  //End of common footers
   ...
   async errorMSGModal() {
      ...
      componentProps: { 'value1': this.translate.instant('version')+ " 2.1.0", 'value': this.translate.instant('VALIDATION_MSG_BUTTON') }
    });
